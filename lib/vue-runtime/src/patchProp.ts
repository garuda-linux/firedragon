import { patchClass } from './modules/class.ts'
import { patchStyle } from './modules/style.ts'
import { patchAttr } from './modules/attrs.ts'
import { patchDOMProp } from './modules/props.ts'
...
import type { VueElement } from './apiCustomElement.ts'
