<script lang="ts" setup>
    ...
    const theme = useIntPref('layout.css.prefers-color-scheme.content-override');
</script>

<template>
    <h1 class="text-h3">{{ t('steps.appearance.header') }}</h1>
    <p>{{ t('steps.appearance.text') }}</p>
