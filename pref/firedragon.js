...
pref('firedragon.settings.design.lepton.advanced', false);
...
pref('userChrome.theme.proton_chrome', true);
pref('userChrome.theme.fully_color', true);
pref('userChrome.theme.fully_dark', true);
pref('userChrome.theme.proton_color.dark_blue_accent', false);
pref('userChrome.theme.monospace', false);


/* SKIN: LEPTON: DECORATION */
...
pref('userChrome.tabbar.move_icon_to_left', false);
...
pref('userChrome.tab.connect_to_window', false);
pref('userChrome.tab.color_like_toolbar', false);
pref('userChrome.tab.lepton_like_padding', false);
...
pref('userChrome.tab.static_separator.selected_accent', false);
pref('userChrome.tab.newtab_button_like_tab', false);
pref('userChrome.tab.newtab_button_smaller', false);
pref('userChrome.tab.newtab_button_proton', true);
