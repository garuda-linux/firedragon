...
declare global {
  ...
  const promptRestartOnChange: typeof import('./src/composables/promptRestartOnChange').default
  ...
  const toggleRefs: typeof import('./src/composables/toggleRefs').default
  ...
  const usePrefHasUserValue: typeof import('./src/composables/usePrefHasUserValue').default
