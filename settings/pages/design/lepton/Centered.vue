<script lang="ts" setup>
    ...
    const centeredTab = await useBoolPref('userChrome.centered.tab');
    const centeredTabLabel = await useBoolPref('userChrome.centered.tab.label');
    ...
    <q-card>
        ...
        <q-list class="q-mb-lg">
            <Item :title="t('pages.design-lepton.centered.centeredTab.title')">
                <TypeSelect
                    v-model="centeredTabType"
                    :options="['none', 'default', 'label']"
                    translation-key="pages.design-lepton.centered.centeredTab.type"
                />
            </Item>
            <BoolPrefItem
                pref="userChrome.centered.urlbar"
                :title="t('pages.design-lepton.centered.centeredUrlbar.title')"
            />
            <BoolPrefItem
                pref="userChrome.centered.bookmarkbar"
                :title="t('pages.design-lepton.centered.centeredBookmarkbar.title')"
            />
        </q-list>
    </q-card>
</template>
